...
| Tatiana Mastrogiovanni Haddad | 🟢 N1 + coordenação | Exercícios 1.1, 1.2, 1.3, 1.4; montagem do `entrega-grupo-aula03.md` e ZIP |
| Luciana Chaves D'Olivo | 🔴 N3 (bônus) | Exercícios 3.1 (spec de tool), 3.2 (benchmark), 3.3 (CI/CD + OIDC) |
